                        ...
                        @forelse($withdrawals as $w)
                            <div class="flex items-center justify-between gap-4 px-5 py-4 transition hover:bg-white/[0.05] sm:px-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-base font-black text-white">{{ number_format($w->amount_fc, 0) }} FC <span class="text-sm font-medium text-slate-400">/</span> <span class="text-sm font-bold text-emerald-300">$ {{ number_format($w->amount_usd, 2) }}</span></p>
