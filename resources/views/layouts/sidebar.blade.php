<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed lg:top-0 bottom-0 left-0 z-50 w-64 bg-green-900 dark:bg-green-950 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 flex flex-col" style="top: calc(4rem + env(safe-area-inset-top)); max-width: 85vw;">
    ...
    <nav class="flex-1 overflow-y-auto px-4 pt-3 pb-4">
        @if(auth()->user()->isAdmin())
            ...
            <x-sidebar-link href="{{ route('admin.notifications.create') }}" :active="request()->routeIs('admin.notifications.*')" icon="<svg class='w-5 h-5 shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9'/></svg>">Notifier</x-sidebar-link>
        @endif
        ...
        @if(auth()->user()->isLivreur())
            ...
            <x-sidebar-link href="{{ route('livreur.withdrawals.index') }}" :active="request()->routeIs('livreur.withdrawals.*')" icon="<svg class='w-5 h-5 shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6'/></svg>">Retraits</x-sidebar-link>
        @endif
        ...
        {{-- Aide & Support --}}
        <div class="pt-2">
            <x-sidebar-link href="{{ route('help') }}" :active="request()->routeIs('help')" icon="<svg class='w-5 h-5 shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z'/></svg>">Aide & Support</x-sidebar-link>
        </div>
