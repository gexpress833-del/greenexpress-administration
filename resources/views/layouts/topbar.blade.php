<header class="fixed top-0 left-0 right-0 lg:left-64 z-40 min-h-16 bg-white/95 dark:bg-gray-800/95 backdrop-blur border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 lg:px-8 transition-colors duration-200" style="padding-top: env(safe-area-inset-top);">
