...
<body>
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="security" style="margin-top: 16px;">
                <strong>Note :</strong> Les livraisons de repas s'effectuent uniquement les jours ouvrables (lundi au vendredi), soit {{ \App\Helpers\DateHelper::subscriptionDeliveryDays($subscription->total_days ?? 0) }} repas livrables sur une durée de {{ $subscription->total_days }} jours calendaires.
            </div>
