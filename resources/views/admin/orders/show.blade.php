    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex justify-between"><span class="text-gray-500 dark:text-gray-400">Total</span><span class="font-bold text-lg text-green-700 dark:text-green-400">{{ number_format($order->total_amount_fc, 0, ',', '.') }} FC<br><span class="text-xs text-gray-500 dark:text-gray-400">$ {{ number_format($order->total_amount, 2) }}</span></span></div>
