    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="flex justify-between"><span class="text-gray-500 dark:text-gray-400">Agent</span><span class="font-medium text-gray-800 dark:text-gray-100">{{ $subscription->agent?->name ?? 'N/A' }}</span></div>
                ...
                <div class="flex justify-between"><span class="text-gray-500 dark:text-gray-400">Prix</span><span class="font-bold text-lg text-green-700 dark:text-green-400">{{ number_format($subscription->price_fc, 0, ',', '.') }} FC<br><span class="text-xs text-gray-500 dark:text-gray-400">$ {{ number_format($subscription->price, 2) }}</span></span></div>
