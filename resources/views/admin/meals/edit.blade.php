    ...
    <div class="max-w-xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.meals.update', $meal) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="image_url" value="{{ old('image_url', str_starts_with($meal->image ?? '', 'http') ? $meal->image : '') }}" placeholder="https://exemple.com/image.jpg" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring-green-500">
