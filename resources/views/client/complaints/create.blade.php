<x-app-layout>
    ...
    <div class="max-w-lg mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <p class="text-sm text-gray-500 mb-4">Commande : <span class="font-medium text-gray-800">{{ $order->code }}</span></p>
        <form method="POST" action="{{ route('client.complaints.store', $order) }}">
            ...
            <div class="mb-4">
                ...
                <select name="type" id="type" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4" maxlength="1000" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500" required></textarea>
