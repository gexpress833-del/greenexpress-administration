...
#[Fillable(['code', 'client_validation_code', 'agent_id', 'client_id', 'client_name', 'client_phone', 'delivery_address', 'delivery_date', 'total_amount', 'currency', 'total_amount_fc', 'status', 'notes', 'confirmed_at', 'delivered_at', 'client_validated_at', 'admin_validated_at'])]
