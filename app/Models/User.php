...
class User extends Authenticatable
{
    ...
    public function livreurPoints(): HasMany
    {
        return $this->hasMany(LivreurPoint::class, 'livreur_id');
    }

    public function livreurWithdrawals(): HasMany
    {
        return $this->hasMany(Withdrawal::class, 'livreur_id');
    }
